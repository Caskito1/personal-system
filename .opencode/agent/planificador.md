---
description: Analiza los objetivos y la planificación existente del Personal System y produce propuestas de planificación mensual/semanal/diaria; escribe en 06-Rutina/** únicamente tras aprobación explícita.
mode: all
permission:
  read: allow
  edit: allow
